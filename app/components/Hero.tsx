      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex flex-col md:flex-row gap-12 items-center">
          <div className="flex-1 animate-slide-in-left">
            ...
            <p className="text-2xl text-[#7fbbb3] mb-6 hover:translate-x-2 transition-transform duration-300">Desenvolvedor Senior</p>
            <p className="text-lg text-[#d3c6aa] mb-8 leading-relaxed">
              Estudo Programação a 5 anos, e atualmente estou Trabalhando na area, mas comecei a <strong>"codar"</strong> desde os meus <strong>14 anos</strong> de idade. Hoje eu sou desenvolvedor sênior na <strong>Prefeitura Municipal de Presidente Bernades em Minas Gerais.</strong>
            </p>
